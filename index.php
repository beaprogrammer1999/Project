 ...
 <!----------Featured Categories---------------->
   <div class="Categories">
   	<div class="small-container">
   	    <div class="row">
   		    <div class="col-3">
   			    <img src="New folder/category-1.jpg">
   		    </div>
   		    <div class="col-3">
   			    <img src="New folder/category-2.jpg">
   		    </div>
   		    <div class="col-3">
   			    <img src="New folder/category-3.jpg">
   		    </div>
   	    </div>
   	</div>
   </div>
...
<!--------------------offer--------------->
    <div class="offer">
    	<div class="small-container">
    		<div class="row">
    			<div class="col-2">
    				<img src="New folder/exclusive.png" class="offer-img">
    			</div>
    			<div class="col-2">
    ...
    <div class="brands">
    	<div class="small-container">
    		<div class="row">
    			...
    			<div class="col-5">
    				<img src="New folder/logo-oppo.png">
    			</div>
    			<div class="col-5">
    				<img src="New folder/logo-coca-cola.png">
    			</div>
    			<div class="col-5">
    				<img src="New folder/logo-paypal.png">
    			</div>
    			<div class="col-5">
    				<img src="New folder/logo-philips.png">
    			</div>
    		</div>
    	</div>
    </div>
